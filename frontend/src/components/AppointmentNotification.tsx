...
import { Video, Phone, Clock, X, Bell, Calendar, MessageCircle } from 'lucide-react';
          ...
          {upcomingAppointments.slice(0, 3).map((appointment) => (
            ...
            >
                  ...
                  <div className="flex items-center space-x-4 text-xs text-gray-600 mt-1">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span>
                        ...
                        {appointment.urgent && (
                          <span className="ml-1 text-red-600 font-semibold">(URGENT)</span>
                        )}
                      </span>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Button 
                  size="sm"
                  className={`${appointment.urgent ? 'bg-red-600 hover:bg-red-700' : 'bg-blue-600 hover:bg-blue-700'} text-white text-xs px-3 py-1`}
