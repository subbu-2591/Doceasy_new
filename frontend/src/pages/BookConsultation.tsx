...
const BookConsultation = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Calculate the consultation fee based on the selected type
      const consultationFee = bookingData.consultation_type === 'chat' 
        ? (doctor.chatConsultationFee || doctor.consultationFee || 1000)
                        ...
                        >
                          ...
                          <div className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-gray-50">
                            ...
                            <Label htmlFor="chat" className="flex items-center cursor-pointer flex-1">
                              <MessageCircle className="h-5 w-5 mr-3 text-medical-blue" />
                              <div>
                                <div className="font-medium">Chat Consultation</div>
                                <div className="text-sm text-gray-600">Secure end-to-end encrypted text chat</div>
                              </div>
                            </Label>
                          </div>
                        </RadioGroup>
                        ...
                        <div className="space-y-3 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="flex items-center">
                              ...
                              ) : bookingData.consultation_type === 'chat' ? (
                                <>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span>₹{bookingData.consultation_type === 'chat' 
                              ? (doctor.chatConsultationFee || doctor.consultationFee || 1000) 
                              : (doctor.consultationFee || 1500)}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between font-semibold">
                            <span>Total:</span>
                            <span>₹{bookingData.consultation_type === 'chat'
                              ? (doctor.chatConsultationFee || doctor.consultationFee || 1000) + (bookingData.urgent ? 500 : 0)
                              : (doctor.consultationFee || 1500) + (bookingData.urgent ? 500 : 0)}
                            </span>
                          </div>
                        </div>
                      </div>
