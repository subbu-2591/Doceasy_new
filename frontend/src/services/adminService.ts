...
export const adminService = {
  ...
  // Google Meet links for appointments
  updateGoogleMeetLink: async (appointmentId: string, googleMeetLink: string) => {
    try {
      validateAuth();
      const response = await api.put(`/api/admin/appointments/${appointmentId}/meet-link`, {
